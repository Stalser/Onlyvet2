...
const sections: Section[] = [
  {
    ...
    body: [
      <p key="1">Быстрее всего — нажать <Link href="/booking" className="text-[var(--teal)] underline">«Записаться»</Link>, указать контакт и кратко описать ситуацию.</p>,
      <p key="2">Также доступны Telegram/VK из шапки. Мы отвечаем оперативно в рабочее время.</p>,
      <p key="3"><b>Важно:</b> при угрозе жизни — <u>срочно</u> в ближайшую клинику, онлайн‑консультация не подходит.</p>
    ]
  },
  {
    id: 'register',
    ...
    body: [
      <ol key="olr" className="list-decimal pl-5 space-y-1">
        ...
        <li>В «Личном кабинете» заполните карточку питомца: порода, вес, возраст.</li>
      </ol>
    ]
  },
  {
    ...
    body: [
      <p key="p1">Стоимость видна при выборе услуги и врача. Оплата картой/СБП, чек — на e‑mail.</p>,
  ...
  },
  {
    ...
    body: [
      <ul key="ulp" className="list-disc pl-5 space-y-1">
        <li>Фото проблемы + общий вид питомца при дневном свете.</li>
        <li>Температура, вес, частота дыхания в покое (если возможно).</li>
        <li>Список лекарств/доз, если что‑то уже принимали.</li>
        <li>Тихое место, стабильный интернет, заряд устройства, наушники.</li>
      </ul>
    ]
  },
  {
    ...
    body: [
      <p key="pa1">В течение 10–30 минут вы получите план лечения в PDF и в «Личном кабинете». Чат открыт 24–48 часов для уточнений.</p>,
