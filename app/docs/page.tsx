...
const groups: Group[] = [
  {
    ...
    items: [
      ...
      { title: 'Политика конфиденциальности', href: '/docs/privacy.pdf', available: false, note: 'PDF будет загружен позже' },
    ]
  },
  {
    title: 'Образцы договоров и согласий',
    items: [
  ...
  return (
    <section className="container py-12 sm:py-16">
      ...
      <div className="mt-6 text-sm opacity-70">
        Если нужен документ срочно — напишите нам через форму связи.
      </div>
    </section>
  );
}
